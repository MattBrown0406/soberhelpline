...
const ZoomMeeting = ({ meetingNumber, password = "", userName, role = 0, onMeetingEnd }: ZoomMeetingProps) => {
  ...
  if (status === "idle") {
    return (
      <div className="flex flex-col items-center gap-4 p-8 bg-muted/30 rounded-xl border">
  ...
  if (status === "error") {
    return (
      <div className="flex flex-col items-center gap-4 p-8 bg-destructive/5 rounded-xl border border-destructive/20">
