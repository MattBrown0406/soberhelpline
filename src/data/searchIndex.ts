...
export const searchIndex: SearchEntry[] = [
  ...
  { title: "Addiction Family Coaching", path: "/addiction-family-coaching", description: "Coaching for boundaries, relapse, family alignment, treatment decisions, and follow-through.", category: "page", keywords: ["family coaching", "addiction coaching", "boundaries", "relapse", "family alignment"] },
