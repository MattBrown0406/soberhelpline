...
const faqItems = [
  {
    ...
    answer:
      "The most effective approach combines education, boundary-setting, and evidence-based strategies like CRAFT (Community Reinforcement and Family Training). CRAFT teaches families how to reduce enabling behaviors, communicate effectively, and create conditions that motivate their loved one toward treatment — without confrontation. Arizona families can also connect with Al-Anon, Nar-Anon, and Sober Helpline's free Monday night Zoom calls for ongoing support. If your loved one is resistant to treatment, a professional intervention coach can guide you through the process step by step.",
  },
  {
    question: "Are there free family support groups for addiction in Arizona?",
    answer:
      "Yes. Arizona has Al-Anon meetings across the state, Nar-Anon groups for families of narcotics users, and SMART Recovery Family & Friends meetings. Sober Helpline also offers a free Monday night Zoom call every week at 7PM PST — led by a certified interventionist — open to any Arizona family, no sign-up fees or treatment center referrals.",
  },
  {
    question: "Why is Arizona's fentanyl crisis so severe?",
    answer:
      "Arizona's southern border location has made it a primary entry point for fentanyl trafficking from Mexico. Fentanyl pills disguised as legitimate prescription drugs have flooded communities statewide, and Maricopa County alone accounts for over 1,200 overdose deaths per year. Phoenix ranks among the top 5 US cities for methamphetamine use. The combination of fentanyl, meth, and border proximity makes Arizona one of the most high-risk states for families dealing with addiction.",
  },
  {
    question: "What is enabling and how do I stop it?",
    answer:
      "Enabling means taking actions that protect your loved one from the natural consequences of their addiction — paying their bills, making excuses, covering up their behavior, or bailing them out of crises. While it comes from love, enabling removes the motivation to change. To stop enabling, you set clear boundaries with real consequences attached: 'I will not pay rent if you are actively using.' This is not punishment — it's removing the safety net that lets addiction continue. Sober Helpline coaching helps Arizona families identify enabling patterns and replace them with boundary-based responses.",
  },
  {
    question: "Should I stage an intervention for my loved one in Arizona?",
    answer:
      "An intervention may be appropriate when your loved one is in denial, has refused treatment multiple times, or when the situation is becoming dangerous. Confrontational 'surprise' interventions have mixed results. A more effective model is the family-led approach: equip yourself first, set firm boundaries, and create the conditions where treatment becomes the logical choice. Sober Helpline offers hourly intervention coaching for Arizona families — you work directly with an interventionist who helps you prepare without requiring an expensive in-person team.",
  },
];

const cities = [
  { name: "Phoenix", slug: "phoenix", description: "Maricopa County — Arizona's largest city" },
  { name: "Tucson", slug: "tucson", description: "Pima County — Southern Arizona" },
  { name: "Scottsdale", slug: "scottsdale", description: "Maricopa County — East Valley" },
];
...
const localBusinessSchema = {
  ...
  name: "Sober Helpline",
  description:
    "Family support and intervention coaching for families affected by addiction. Serving Arizona families with free resources, Monday night Zoom, and hourly coaching.",
  ...
  return (
    <>
      <SEOHead
        ...
        description="Arizona families struggling with a loved one's addiction get real help. Support groups, intervention resources, CRAFT therapy, and expert guidance. Free resources available."
        faqItems={faqItems}
        ...
        <section className="bg-gradient-to-b from-primary/10 to-background py-14 md:py-20">
          <div className="container max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="hero-description text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Arizona is on the front lines of the fentanyl and meth epidemic — and families are bearing the weight.
        ...
        <section className="py-12 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-logo-green text-center mb-3">
              Arizona's Addiction Crisis Is a Family Crisis
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="text-center">
                <CardContent className="p-6">
                  ...
                  <div className="text-sm text-muted-foreground">Arizona loses over 2,000 residents to overdose every year — a staggering toll on families statewide</div>
                </CardContent>
              </Card>
              <Card className="text-center">
                <CardContent className="p-6">
                  <div className="text-4xl font-bold text-primary mb-2">1,200+</div>
                  <div className="font-semibold text-logo-green mb-1">Maricopa County Deaths</div>
                  <div className="text-sm text-muted-foreground">Maricopa County alone accounts for more than 1,200 overdose deaths per year — a county-level crisis</div>
                </CardContent>
              </Card>
              <Card className="text-center">
                <CardContent className="p-6">
                  <div className="text-4xl font-bold text-primary mb-2">Top 5</div>
                  <div className="font-semibold text-logo-green mb-1">Phoenix Meth Crisis</div>
                  <div className="text-sm text-muted-foreground">Phoenix ranks among the top 5 US cities for methamphetamine use — compounding the fentanyl epidemic</div>
                </CardContent>
              </Card>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Arizona families face this every day — with fentanyl flooding across the border and meth deeply embedded 
                  in communities from Phoenix to Tucson. Too many suffer in isolation, convinced they're the only ones.
              ...
              <div>
                ...
                <ul className="space-y-2 mb-6">
                  {[
                    ...
                    "Connect with other Arizona families going through the same thing",
