...
const faqItems = [
  {
    ...
    answer:
      "The most effective approach combines education, boundary-setting, and evidence-based strategies like CRAFT (Community Reinforcement and Family Training). CRAFT teaches families how to reduce enabling behaviors, communicate effectively, and create conditions that motivate their loved one toward treatment — without confrontation. California families can also connect with Al-Anon, Nar-Anon, and Sober Helpline's free “The Family Squares” calls for ongoing support. If your loved one is resistant to treatment, a professional intervention coach can guide you through the process step by step.",
  },
  {
    question: "Are there free family support groups for addiction in California?",
    answer:
      "Yes. California has Al-Anon meetings across the state (al-anon.org/find-a-meeting), Nar-Anon groups for families of narcotics users (nar-anon.org), and SMART Recovery Family & Friends meetings statewide. The California Department of Health Care Services (dhcs.ca.gov) also connects families with county-level resources. Sober Helpline offers a free “The Family Squares” call every week at 7PM PST — led by a certified interventionist — open to any California family, no sign-up fees or treatment center referrals.",
  },
  {
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-12">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <WhatsAppLink source="california_cta_1" variant="button" className="" />
                </div>
              </div>
        ...
        <section className="py-12 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <WhatsAppLink source="california_cta_2" variant="button" className="" />
            </div>
          </div>
        </section>
