...
const faqItems = [
  {
    question: "How do I help a family member with addiction in California?",
    answer:
      "The most effective approach combines education, boundary-setting, and evidence-based strategies like CRAFT (Community Reinforcement and Family Training). CRAFT teaches families how to reduce enabling behaviors, communicate effectively, and create conditions that motivate their loved one toward treatment — without confrontation. California families can also connect with Al-Anon, Nar-Anon, and Sober Helpline's free Monday night Zoom calls for ongoing support. If your loved one is resistant to treatment, a professional intervention coach can guide you through the process step by step.",
  },
  {
    question: "Are there free family support groups for addiction in California?",
    answer:
      "Yes. California has Al-Anon meetings across the state (al-anon.org/find-a-meeting), Nar-Anon groups for families of narcotics users (nar-anon.org), and SMART Recovery Family & Friends meetings statewide. The California Department of Health Care Services (dhcs.ca.gov) also connects families with county-level resources. Sober Helpline offers a free Monday night Zoom call every week at 7PM PST — led by a certified interventionist — open to any California family, no sign-up fees or treatment center referrals.",
  },
  {
  ...
  {
    question: "Should I stage an intervention for my loved one in California?",
    answer:
      "An intervention may be appropriate when your loved one is in denial, has refused treatment multiple times, or when the situation is becoming dangerous. Confrontational 'surprise' interventions have mixed results. A more effective model is the family-led approach: equip yourself first, set firm boundaries, and create the conditions where treatment becomes the logical choice. Sober Helpline offers hourly intervention coaching for California families — you work directly with an interventionist who helps you prepare without requiring an expensive in-person team.",
  },
  {
    question: "How do I find addiction treatment for my loved one in California?",
    answer:
      "Start with Sober Helpline's free Treatment Finder at soberhelpline.com/treatment-finder — a vetted directory of ethical providers with no referral fees. You can also contact the California Department of Health Care Services (dhcs.ca.gov) for state-funded and Medi-Cal covered treatment options, or call SAMHSA's National Helpline at 1-800-662-4357 for 24/7 crisis support and referrals. Our Monday night Zoom is a great place to ask questions about California treatment options in a judgment-free environment.",
  },
];

const cities = [
  { name: "Sacramento", slug: "sacramento", description: "Sacramento County — state capital, fentanyl/meth crisis" },
  { name: "San Francisco", slug: "san-francisco", description: "SF County — fentanyl epicenter of the US" },
  { name: "Oakland", slug: "oakland", description: "Alameda County — highest Bay Area overdose rates" },
  { name: "San Jose", slug: "san-jose", description: "Santa Clara County — Silicon Valley, high-functioning addiction" },
  { name: "Los Angeles", slug: "los-angeles", description: "LA County — 1,800+ overdose deaths/year" },
  { name: "Long Beach", slug: "long-beach", description: "LA County — port city, fentanyl trafficking" },
  { name: "Orange County", slug: "orange-county", description: "OC — affluent communities, prescription opioids" },
];
...
const localBusinessSchema = {
  ...
  name: "Sober Helpline",
  description:
    "Family support and intervention coaching for families affected by addiction. Serving California families with free resources, Monday night Zoom, and hourly coaching.",
  ...
  return (
    <>
      <SEOHead
        ...
        description="California families struggling with a loved one's addiction get real help. Support groups, intervention resources, CRAFT therapy, and expert guidance. Free resources available."
        faqItems={faqItems}
        ...
        <section className="bg-gradient-to-b from-primary/10 to-background py-14 md:py-20">
          <div className="container max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="hero-description text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              California leads the nation in drug overdose deaths — and families across the state are bearing
              the weight. From Los Angeles to Sacramento, from the Bay Area to Orange County, families need
              real help. Free guidance, evidence-based strategies, and support are available right now.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  California families face this every day — from San Francisco's Tenderloin to LA's Skid Row,
                  from Sacramento's streets to affluent neighborhoods in Orange County.
          ...
          <div className="container max-w-4xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Every Monday at 7PM PST, families across California (and nationwide) join a free Zoom call
                ...
                <ul className="space-y-2 mb-6">
                  {[
                    ...
                    "Connect with other California families going through the same thing",
