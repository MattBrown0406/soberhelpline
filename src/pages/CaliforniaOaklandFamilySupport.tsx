  ...
  return (
    <>
      <SEOHead
        ...
        description="Families in Oakland struggling with a loved one's addiction get expert support from Sober Helpline. Free “The Family Squares” every Monday 7PM PST. (458) 298-8008."
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="bg-gradient-to-b from-primary/10 to-background py-12 md:py-16">
          <div className="container max-w-4xl mx-auto px-4 text-center">
            ...
            <WhatsAppLink source="california_oakland_cta_1" variant="button" className="w-full sm:w-auto" />
            <WhatsAppLink source="california_oakland_cta_1" variant="button" className="w-full sm:w-auto" />
            </div>
          </div>
        </section>
        ...
        <section className="py-12 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <WhatsAppLink source="california_oakland_cta_2" variant="button" />
            <WhatsAppLink source="california_oakland_cta_2" variant="button" className="" />
            </div>
          </div>
        </section>
