  ...
  return (
    <>
      <SEOHead
        ...
        description="Families in San Francisco struggling with a loved one's addiction get expert support from Sober Helpline. Free “The Family Squares” every Monday 7PM PST. (458) 298-8008."
              ...
              <Card className="md:col-span-2">
                ...
                <CardContent>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <a href="tel:+18003092131" className="inline-flex items-center gap-2 text-primary font-semibold text-sm hover:underline">
                      <Phone className="h-4 w-4" />
