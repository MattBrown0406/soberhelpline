...
const localBusinessSchema = {
  ...
  name: "Sober Helpline",
  description:
    "Family support and intervention coaching for families affected by addiction. Serving Colorado families with free resources, “The Family Squares”, and hourly coaching.",
      ...
      <div className="min-h-screen bg-background">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="text-center">
                <CardContent className="p-6">
                  ...
                  <div className="font-semibold text-logo-blue mb-1">Denver for Cocaine & Meth</div>
        ...
        <section className="py-12">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <WhatsAppLink source="colorado_cta_1" variant="button" />
            <WhatsAppLink source="colorado_cta_1" variant="button" className="" />
                </div>
              </div>
        ...
        <section className="py-12 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <WhatsAppLink source="colorado_cta_2" variant="button" />
            <WhatsAppLink source="colorado_cta_2" variant="button" className="" />
            </div>
          </div>
        </section>
