    ...
    answer: (
      <>
        ...
        **State-Funded and Non-Profit Programs:**{"\n"}
        ...
        • <a href="https://www.salvationarmyusa.org/usn/adult-rehabilitation-centers/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">Salvation Army Adult Rehabilitation Centers</a> offer free long-term treatment{"\n"}
