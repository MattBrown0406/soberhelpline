...
function scoreAnswers(answers: Answers): {
  ...
  if (urgency === "crisis") {
    ...
    summary = `You've likely tried things that haven't worked. That's not your fault — most of what families try is well-intentioned but ineffective. The Monday night Zoom is a great place to start: ask real questions, hear from other families, and get guidance from a certified interventionist at no cost.`;
    primaryCTA = "zoom";
  } else {
