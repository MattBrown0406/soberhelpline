...
const localBusinessSchema = {
  ...
  name: "Sober Helpline",
  description:
    "Family support and intervention coaching for families affected by addiction. Serving Idaho families with free resources, Monday night Zoom, and hourly coaching.",
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-12 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
              Free, established resources available to Idaho families right now.
            </p>
            <div className="grid gap-4 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    Idaho's statewide resource and referral service. Dial 211 to connect with local behavioral
                    health services, treatment programs, and family support resources across all Idaho counties.
                  </p>
                  <a
                    href="tel:211"
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    Free, anonymous, and available across Idaho — including online meetings for rural families.
                  </p>
                  <a
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    Idaho Department of Health and Welfare's behavioral health division. Connects families with
                    state-funded treatment programs, Medicaid-covered services, and county mental health resources.
                  </p>
                  <a
                    href="https://healthandwelfare.idaho.gov/services-programs/behavioral-health"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 text-primary text-sm hover:underline"
                  >
                    healthandwelfare.idaho.gov <ExternalLink className="h-3 w-3" />
                  </a>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    and cognitive-behavioral strategies. Available online — ideal for rural Idaho families.
                  </p>
                  <a
              ...
              <Card className="md:col-span-2">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    Idaho's statewide crisis line for mental health and substance use emergencies.
        ...
        <section className="py-12 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
              Find addiction family support resources specific to your city in Idaho.
            </p>
