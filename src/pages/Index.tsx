          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-3 px-4">
              <Link to="/family-situation-assessment">
                <Button size="lg" className="gap-2 md:gap-3 bg-logo-green hover:bg-logo-green/90 text-white px-6 md:px-8 py-4 text-sm md:text-base shadow-lg shadow-logo-green/25 hover:shadow-xl hover:shadow-logo-green/30 transition-all items-center">
                  <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
                  <span>Take the Free Family Assessment</span>
                  <span className="hidden md:inline text-xs font-normal opacity-90">· 2 min · Free · No login</span>
                </Button>
              </Link>
            </div>
