      ...
      <div className="container mx-auto px-4 py-4 md:py-8">
        ...
        <div className="mb-8 md:mb-12 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="w-full md:w-1/2 lg:w-3/5 flex items-center justify-center">
            <img src={logo} alt="Sober Helpline" className="h-auto max-h-[56.25vw] md:max-h-[calc((50vw-3rem)*9/16)] lg:max-h-[calc((40vw-3rem)*9/16)] w-auto border-2 border-black rounded-lg" />
          </div>
        </div>
        ...
        <div className="text-center mb-6">
          <Link to="/family-membership">
            <Button variant="outline" size="lg" className="flex items-center gap-3 mx-auto text-base px-6 py-3 border-primary text-primary hover:bg-primary/10">
              ...
              Unlock Premium Member Services (Over 60 Different Exercises, Videos and Guides) — $14.99/month, cancel anytime
            </Button>
          </Link>
        </div>
