...
const landingPages: IntentLandingConfig[] = [
  ...
  },
  {
    ...
    h1: "Coaching for families who need practice, not just insight.",
    intro:
      "If the problem keeps repeating after every good conversation, coaching gives the family structure, language, and follow-through around boundaries, relapse response, treatment choices, and communication.",
    primaryCta: "See coaching options",
    ...
    fit: [
      "You know the pattern but cannot hold the boundary under pressure.",
      "Relapse, early recovery, or aftercare is putting the family back into old roles.",
      "Parents, partners, or siblings need to get on the same page.",
    ],
    outcomes: [
