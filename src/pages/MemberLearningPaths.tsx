...
const paths: LearningPath[] = [
  ...
  },
  {
    ...
    resources: [
      { title: "Boundaries vs. Ultimatums — What's the Difference?", path: "/boundaries-ultimatums", type: "guide", note: "Critical distinction before any conversation" },
      { title: "The No-Negotiation Guide", path: "/no-negotiation", type: "guide" },
  ...
  },
  {
    ...
    resources: [
      ...
      { title: "Relapse Warning Signs Tracker", path: "/relapse-warning-signs", type: "tool" },
  ...
  },
  {
    ...
    resources: [
      { title: "The Strong One Guide", path: "/strong-one", type: "guide", note: "Start here — many families need this most" },
      { title: "Grief for Families Navigating Addiction", path: "/grief-for-family", type: "guide" },
      { title: "Guilt, Relief & the Resentment Cycle", path: "/guilt-relief-resentment", type: "guide" },
