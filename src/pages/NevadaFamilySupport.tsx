...
const faqItems = [
  {
    "question": "Is Sober Helpline based in a local Nevada office?",
    "answer": "This page describes remote support available to families in Nevada, not a staffed local office. Family Squares meets online, and private coaching is available by phone or video."
  },
  {
    "question": "Which Sober Helpline support is free for Nevada families?",
  ...
  {
    "question": "Where can I look for local resources in Nevada?",
    "answer": "The Nevada resource section below links to outside organizations and existing city guides. Check with each organization for current meeting times, eligibility, costs, and availability; these are not Sober Helpline offices."
  }
];

const cities = [
  { name: "Las Vegas", slug: "las-vegas", description: "Clark County" },
  { name: "Henderson", slug: "henderson", description: "Clark County" },
  { name: "Reno", slug: "reno", description: "Washoe County" },
];

const familySupportSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Remote family support for Nevada",
  "serviceType": "Family education and coaching",
  "description": "Remote family education and coaching available to families in Nevada.",
  "url": "https://soberhelpline.com/nevada-family-support",
  "provider": {
    "@type": "Organization",
    "name": "Sober Helpline",
  ...
  return (
    <>
      <SEOHead
        ...
        canonicalPath="/nevada-family-support"
        faqItems={faqItems}
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="bg-gradient-to-b from-primary/10 to-background py-14 md:py-20">
          <div className="container max-w-4xl mx-auto px-4 text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-logo-blue mb-5 leading-tight">
              Family Support for Addiction in Nevada
            </h1>
            <p className="hero-description text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Families in Nevada can connect with Sober Helpline by phone or online for education and coaching. Start with the free Monday Family Squares meeting, compare paid support options, or use the state resource links below. This page describes remote support, not a local office.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:4582988008">
                <Button size="lg" className="gap-2 w-full sm:w-auto">
                  <Phone className="h-4 w-4" />
                  Call for Family Guidance
                </Button>
              </a>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Support is available to your family in Nevada, even if you are not sure what to do next. You can ask questions about your own needs without committing to a paid service.
                </p>
        ...
        <RegionalFamilySupportOptions state="Nevada" />
          ...
          <div className="container max-w-4xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Every Monday at 7PM Pacific, families across Nevada (and nationwide) join a free Zoom call
