...
const faqItems = [
  {
    ...
    answer:
      "The most effective approach combines education, boundary-setting, and evidence-based strategies like CRAFT (Community Reinforcement and Family Training). CRAFT teaches families how to reduce enabling behaviors, communicate effectively, and create conditions that motivate their loved one toward treatment — without confrontation. Nevada families can also connect with Al-Anon, Nar-Anon, and Sober Helpline's free Monday night Zoom calls for ongoing support. If your loved one is resistant to treatment, a professional intervention coach can guide you through the process step by step.",
  },
  {
    question: "Are there free family support groups for addiction in Nevada?",
    answer:
      "Yes. Nevada has Al-Anon meetings across the state (al-anon.org/find-a-meeting), Nar-Anon groups for families of narcotics users, and SMART Recovery Family & Friends meetings. Sober Helpline also offers a free Monday night Zoom call every week at 7PM PST — led by a certified interventionist — open to any Nevada family, no sign-up fees or treatment center referrals.",
  },
  {
...
const localBusinessSchema = {
  ...
  name: "Sober Helpline",
  description:
    "Family support and intervention coaching for families affected by addiction. Serving Nevada families with free resources, Monday night Zoom, and hourly coaching.",
