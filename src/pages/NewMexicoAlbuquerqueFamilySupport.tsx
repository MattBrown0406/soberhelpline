  ...
  return (
    <>
      <SEOHead
        ...
        description="Families in Albuquerque struggling with a loved one's addiction get expert support, resources, and guidance from Sober Helpline. Free “The Family Squares”. (541) 241-5668."
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-10 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-logo-green mb-4">Albuquerque's Addiction Landscape</h2>
        ...
        <section className="py-10">
          <div className="container max-w-4xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-logo-green mb-6">Albuquerque Family Addiction Resources</h2>
        ...
        <section className="py-10 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <h2 className="text-2xl font-bold text-logo-green mb-3">Albuquerque Families: Help Is Here</h2>
