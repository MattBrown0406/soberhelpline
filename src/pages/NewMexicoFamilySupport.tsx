...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "New Mexico consistently ranks as the state with the highest drug overdose death rate per capita in the United States — over 40 deaths per 100,000 residents annually. Several factors converge: significant poverty, high rates of trauma and adverse childhood experiences, geographic isolation in rural areas, proximity to drug trafficking routes, a history of prescription opioid overprescribing, and limited behavioral health infrastructure. Albuquerque ranks in the top 5 US cities for overdose deaths. Fentanyl, methamphetamine, and heroin all drive deaths, often in combination.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Enabling means taking actions that protect your loved one from the natural consequences of their addiction — paying their bills, making excuses, covering up their behavior, or bailing them out of crises. In New Mexico, where multigenerational family structures are common and cultural norms around loyalty run deep, enabling often looks like 'keeping the peace' or 'protecting the family name.' While it comes from love, enabling removes the motivation to change. Sober Helpline coaching helps families — including Native American and Latino families with unique cultural dynamics — identify enabling patterns and replace them with boundary-based responses.",
  },
  {
...
const cities = [
  { name: "Albuquerque", slug: "albuquerque", description: "Bernalillo County — New Mexico's largest city" },
  { name: "Santa Fe", slug: "santa-fe", description: "Santa Fe County — New Mexico's state capital" },
  { name: "Las Cruces", slug: "las-cruces", description: "Doña Ana County — Border region, NMSU" },
];
...
export default function NewMexicoFamilySupport() {
  return (
    <>
      <SEOHead
        title="Alcohol Interventionist in New Mexico | Family Addiction Support"
        description="Need an alcohol interventionist in New Mexico? Get family addiction coaching, Monday Zoom support, and clear next steps for relapse, treatment refusal, or crisis."
        faqItems={faqItems}
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="bg-gradient-to-b from-primary/10 to-background py-14 md:py-20">
          <div className="container max-w-4xl mx-auto px-4 text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-logo-blue mb-5 leading-tight">
              Alcohol Interventionist and Family Addiction Support in New Mexico
            </h1>
            <p className="hero-description text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              New Mexico families can start with the free Monday Zoom, book private coaching, or call when the situation may require intervention planning.
            </p>
          ...
          <div className="container max-w-4xl mx-auto px-4">
            <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6 md:p-8">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-logo-blue mb-3">
                Need an alcohol interventionist in New Mexico?
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  The shame that keeps New Mexico families silent.
                </p>
                <p className="text-muted-foreground mb-6">
                  New Mexico families — across Albuquerque's neighborhoods, Santa Fe's art communities, Las Cruces' border region —
                  face this every day. In a state where cultural ties run deep and asking for help can feel like betrayal,
                  many families suffer in silence. Change is possible — and it often starts with the family, not the person using.
                </p>
        ...
        <section className="py-12 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
              Free, established resources available to New Mexico families right now.
            </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    Free, anonymous, and available across New Mexico including Albuquerque, Santa Fe, and Las Cruces.
                  </p>
                  <a
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    Regular meetings statewide, including virtual options for rural New Mexico families.
                  </p>
                  <a
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    and cognitive-behavioral strategies. Free meetings online — accessible from anywhere in NM.
                  </p>
                  <a
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    health services across New Mexico. Find local treatment providers and crisis resources.
                  </p>
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-primary text-sm hover:underline"
                  >
                    nmhealth.org <ExternalLink className="h-3 w-3" />
                  </a>
                </CardContent>
              </Card>
              ...
              <div>
                ...
                <ul className="space-y-2 mb-6">
                  {[
                    ...
                    "Connect with other New Mexico families going through the same thing",
                ...
                <div className="text-center">
                  ...
                  <div className="border-t border-border pt-4 space-y-2 text-sm text-muted-foreground text-left">
                    <div className="flex items-center gap-2">
                      ...
                      Open to all New Mexico families
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle2 className="h-4 w-4 text-primary" />
          ...
          <div className="container max-w-4xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-8 items-start">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Sometimes New Mexico families need more than a support group. They need a strategy.
                ...
                <ul className="space-y-3 mb-6">
                  {[
                    ...
                    "Available by phone or video — anywhere in New Mexico",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-muted-foreground">{item}</span>
            ...
            <WhatsAppLink source="new_mexico_cta_1" variant="button" />
            <WhatsAppLink source="new_mexico_cta_1" variant="button" className="" />
                </div>
              </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6 border-t border-border pt-4">
                    <p className="text-sm text-muted-foreground">
                      <strong className="text-foreground">Treatment Finder:</strong> Looking for New Mexico treatment options?
                    ...
                    <Link to="/inpatient-treatment" className="text-primary text-sm hover:underline inline-block mt-2">
                      Browse New Mexico Treatment Providers →
                    </Link>
                  </div>
                </CardContent>
              </Card>
        ...
        <section className="py-12 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
              Find addiction family support resources specific to your city in New Mexico.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {cities.map((city) => (
                <Link
                  key={city.slug}
                  to={`/new-mexico/${city.slug}`}
        ...
        <section className="py-12 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <WhatsAppLink source="new_mexico_cta_2" variant="button" />
            <WhatsAppLink source="new_mexico_cta_2" variant="button" className="" />
            </div>
          </div>
        </section>
