...
const faqItems = [
  {
    "question": "Is Sober Helpline based in a local Oregon office?",
    "answer": "This page describes remote support available to families in Oregon, not a staffed local office. Family Squares meets online, and private coaching is available by phone or video."
  },
  {
  ...
  },
  {
    ...
    "answer": "The Oregon resource section below links to outside organizations and existing city guides. Check with each organization for current meeting times, eligibility, costs, and availability; these are not Sober Helpline offices."
  }
];

const cities = [
  { name: "Portland", slug: "portland", description: "Multnomah County" },
  { name: "Salem", slug: "salem", description: "Marion County" },
  { name: "Eugene", slug: "eugene", description: "Lane County" },
  { name: "Bend", slug: "bend", description: "Deschutes County" },
  { name: "Medford", slug: "medford", description: "Jackson County" },
  { name: "Gresham", slug: "gresham", description: "East Multnomah County" },
  { name: "Hillsboro", slug: "hillsboro", description: "Washington County" },
];

const familySupportSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Remote family support for Oregon",
  "serviceType": "Family education and coaching",
  "description": "Remote family education and coaching available to families in Oregon.",
  "url": "https://soberhelpline.com/oregon-family-support",
  "provider": {
    "@type": "Organization",
    "name": "Sober Helpline",
  ...
  return (
    <>
      <SEOHead
        ...
        canonicalPath="/oregon-family-support"
        faqItems={faqItems}
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="bg-gradient-to-b from-primary/10 to-background py-14 md:py-20">
          <div className="container max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="hero-description text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Families in Oregon can connect with Sober Helpline by phone or online for education and coaching. Start with the free Monday Family Squares meeting, compare paid support options, or use the state resource links below. This page describes remote support, not a local office.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Support is available to your family in Oregon, even if you are not sure what to do next. You can ask questions about your own needs without committing to a paid service.
                </p>
        ...
        <RegionalFamilySupportOptions state="Oregon" />
        ...
        <section className="py-12">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <WhatsAppLink source="oregon_cta_1" variant="button" />
                </div>
              </div>
        ...
        <section className="py-12 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <WhatsAppLink source="oregon_cta_2" variant="button" />
            </div>
          </div>
        </section>
