          ...
          <div className="mx-auto grid max-w-4xl gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground">
                ...
                <ul className="list-disc space-y-1 pl-6">
                  ...
                  <li>Phone: <a className="text-primary underline" href="tel:+14582988008">(458) 298-8008</a></li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-muted-foreground">
                ...
                <p>Phone: <a className="text-primary underline" href="tel:+14582988008">(458) 298-8008</a></p>
              </CardContent>
            </Card>
          </div>
        </section>
