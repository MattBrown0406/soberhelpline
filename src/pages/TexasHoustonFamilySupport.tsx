  ...
  return (
    <>
      <SEOHead
        ...
        description="Families in Houston struggling with a loved one's addiction get expert support, resources, and guidance from Sober Helpline. Free “The Family Squares”. (458) 298-8008."
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-10 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-logo-blue mb-4">Houston's Addiction Landscape</h2>
        ...
        <section className="py-10">
          <div className="container max-w-4xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-logo-blue mb-6">Houston Family Addiction Resources</h2>
        ...
        <section className="py-10 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <h2 className="text-2xl font-bold text-logo-blue mb-3">Houston Families: Help Is Here</h2>
            ...
            <WhatsAppLink source="texas_houston_cta_1" variant="button" />
            <WhatsAppLink source="texas_houston_cta_1" variant="button" className="" />
            </div>
          </div>
        </section>
