        ...
        <div className="space-y-8">
          ...
          <section className="bg-card border border-border rounded-lg p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-semibold text-logo-blue">What Is Addiction?</h2>
            </div>
          ...
          <section className="bg-card border border-border rounded-lg p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              <AlertTriangle className="h-6 w-6 text-logo-blue" />
              <h2 className="text-xl md:text-2xl font-semibold text-logo-blue">Brain Science Behind the Shift</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
          ...
          <section className="bg-card border border-border rounded-lg p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              <Heart className="h-6 w-6 text-logo-blue" />
              <h2 className="text-xl md:text-2xl font-semibold text-logo-blue">Why "Just Stopping" Isn't Simple</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
          ...
          <section className="bg-card border border-border rounded-lg p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-semibold text-logo-blue">The Role of Genetics and Environment</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
          ...
          <section className="bg-card border border-border rounded-lg p-6 md:p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-semibold text-logo-blue">Why the "Choice" Myth Persists</h2>
            </div>
            <div className="text-muted-foreground space-y-4">
              <p>
