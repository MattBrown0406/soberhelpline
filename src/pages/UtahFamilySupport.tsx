...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Utah's predominantly LDS culture creates unique dynamics around addiction. There is often significant shame associated with substance use — both for the person struggling and for family members who fear judgment from their congregation or community. This can lead to delayed help-seeking, hidden problems, and family systems that protect appearances rather than address the real issue. Sober Helpline's Monday night Zoom is completely anonymous and judgment-free — a safe space where Utah families can get real help without anyone in their community finding out.",
  },
  {
    question: "How do I find addiction treatment for my loved one in Utah?",
    answer:
      "Start with Sober Helpline's free Treatment Finder at soberhelpline.com/treatment-finder — a vetted directory of ethical providers with no referral fees. You can also call the Utah Crisis Line at 1-800-273-8255, contact Valley Behavioral Health (valleybehavioralhealth.org), or reach USARA for peer support resources. Our Monday night Zoom is a great place to ask questions about Utah treatment options in a judgment-free environment.",
  },
];
...
const localBusinessSchema = {
  ...
  name: "Sober Helpline",
  description:
    "Family support and intervention coaching for families affected by addiction. Serving Utah families with free resources, Monday night Zoom, and hourly coaching.",
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-12 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
              Free, established resources available to Utah families right now.
            </p>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    Free, anonymous, and available across Utah — including online for rural and suburban families.
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    Utah's peer recovery organization. Provides support, advocacy, and connection to recovery resources
                    for individuals and families across the state.
                  </p>
                  <a href="https://usara.org" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-primary text-sm hover:underline">
                    usara.org <ExternalLink className="h-3 w-3" />
                  </a>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    One of Utah's largest behavioral health providers. Offers outpatient substance use treatment,
                    crisis services, and family support programs across the Wasatch Front.
                  </p>
              ...
              <Card className="md:col-span-2">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    ...
                    facing substance use disorders in Utah.
                  </p>
              ...
              <div className="bg-white rounded-xl border border-primary/20 p-6 shadow-sm">
                <div className="text-center">
                  ...
                  <div className="border-t border-border pt-4 space-y-2 text-sm text-muted-foreground text-left">
                    ...
                    <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" />No judgment. No shame. No agenda.</div>
                  </div>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <a href="tel:5418386009">
                    <Button size="lg" variant="outline" className="gap-2"><Phone className="h-4 w-4" />Call (541) 838-6009</Button>
                  </a>
                </div>
              </div>
        ...
        <section className="py-12 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
              Find addiction family support resources specific to your city in Utah.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {cities.map((city) => (
                <Link key={city.slug} to={`/utah/${city.slug}`} className="block group">
