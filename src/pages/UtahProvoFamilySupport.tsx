  ...
  return (
    <>
      <SEOHead
        ...
        description="Families in Provo struggling with a loved one's addiction get expert support, resources, and guidance from Sober Helpline. Free “The Family Squares”. (458) 202-7900."
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-10 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-logo-blue mb-2">Provo Families: You Don't Have to Do This Alone</h2>
