  ...
  return (
    <>
      <SEOHead
        ...
        description="Families in Salt Lake City struggling with a loved one's addiction get expert support, resources, and guidance from Sober Helpline. Free “The Family Squares”. (458) 202-7900."
      ...
      <div className="min-h-screen bg-background">
              ...
              <CardContent className="p-6 md:p-8">
                <div className="grid md:grid-cols-2 gap-6 items-center">
                  ...
                  <div className="text-center">
                    ...
                    <a href="tel:4582027900" className="text-primary font-semibold text-lg hover:underline">(458) 202-7900</a>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a href="tel:4582027900"><Button size="lg" variant="outline" className="w-full gap-2"><Phone className="h-4 w-4" />Call (458) 202-7900</Button></a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-logo-blue mb-2">Salt Lake City Families: You Don't Have to Do This Alone</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a href="tel:4582027900"><Button variant="outline" className="gap-2"><Phone className="h-4 w-4" />(458) 202-7900</Button></a>
            </div>
          </div>
        </section>
