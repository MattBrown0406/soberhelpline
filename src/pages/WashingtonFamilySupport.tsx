...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Start with Sober Helpline's free Treatment Finder at soberhelpline.com/treatment-finder — a vetted directory of ethical providers with no referral fees. You can also contact the Washington State Department of Health (doh.wa.gov/substance-use) for state-funded treatment options, or call the Washington Recovery Help Line at 1-866-789-1511 for crisis support and referrals. Our Monday night Zoom is a great place to ask questions about Washington treatment options in a judgment-free environment.",
  },
];
...
const localBusinessSchema = {
  ...
  name: "Sober Helpline",
  description:
    "Family support and intervention coaching for families affected by addiction. Serving Washington State families with free resources, Monday night Zoom, and hourly coaching.",
