  ...
  return (
    <>
      <SEOHead
        ...
        description="Families in Tacoma struggling with a loved one's addiction get expert support and resources from Sober Helpline. Free “The Family Squares”. (458) 298-8008."
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="bg-gradient-to-b from-primary/10 to-background py-12 md:py-16">
          <div className="container max-w-4xl mx-auto px-4 text-center">
            ...
            <WhatsAppLink source="washington_tacoma_cta_1" variant="button" className="w-full sm:w-auto" />
            <WhatsAppLink source="washington_tacoma_cta_1" variant="button" className="w-full sm:w-auto" />
            </div>
          </div>
        </section>
        ...
        <section className="py-12 bg-primary/5 border-t border-primary/10">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <WhatsAppLink source="washington_tacoma_cta_2" variant="button" />
            <WhatsAppLink source="washington_tacoma_cta_2" variant="button" className="" />
            </div>
          </div>
        </section>
