-- Fix provider_submissions_public exposure finding permanently by removing contact columns entirely.
-- Note: Postgres cannot remove columns via CREATE OR REPLACE VIEW; we must drop & recreate.
